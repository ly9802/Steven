...
#get data
sqlite3 biopics.sqlite 'select subject_sex, sum(box_office) from biopics group by subject_sex' > temp1.csv
...
# connect file
cat top.html title.html body.html bottom.html > sa2.html
# remove the temporary files
rm biopics.sqlite biopics1.csv biopics.csv temp1.csv body.csv title.csv title.html body.html top.html bottom.html
